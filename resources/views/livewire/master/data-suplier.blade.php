<div class="page-inner">
    <div class="row">
                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3 text-capitalize"></i>data suplier</span>
                        </a>
        ...
        <div class="col-md-12">
            <livewire:table.data-suplier-table />
        </div>
            ...
            <div class="modal-dialog" permission="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-capitalize" id="my-modal-title">{{$update_mode ? 'Update' : 'Tambah'}} data suplier</h5>
                    </div>
                    <div class="modal-body">
                        <x-text-field type="text" name="suplier_nama" label="Nama Suplier" />
<x-text-field type="number" name="suplier_telepon" label="Telepon" />
<x-textarea type="textarea" name="suplier_alamat" label="Alamat" />
<x-textarea type="textarea" name="suplier_keterangan" label="Keterangan" />
                    </div>
