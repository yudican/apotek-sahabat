...
class TransaksiMasukTable extends LivewireDatatable
{
    protected $listeners = ['refreshTable'];
    public $hideable = 'select';
    public $table_name = 'transaksi_masuk';
    public $hide = [];
    public $path = 'obat-masuk';


    public function builder()
    {
        return Transaksi::query()->where('jenis_transaksi', 'obat masuk');
    }
